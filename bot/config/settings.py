...
CAPITAL_TIERS: dict[str, CapitalTier] = {
    ...
    "MICRO": CapitalTier(
        ...
        min_adx_to_trade=32.0,            # Raised to filter out choppy markets
    ...
    "SMALL": CapitalTier(
        ...
        allowed_strategies=["MOMENTUM", "GAMMA_BLAST", "ZERO_TO_HERO", "PULLBACK"],  # STRADDLE_SCALP removed
    ...
    "MEDIUM": CapitalTier(
        ...
        gamma_blast_lot_pct=1.00,          # Reallocated margin
        sl_pct=0.30,                       # Relaxed from 0.16 to prevent option choking on momentum setups
        min_sl_points=8.0,                 # 8 points for medium accounts
        max_trades_per_day=8,              # UNLOCKED: Expanded from 4 to capture multi-stage runners 🚀
