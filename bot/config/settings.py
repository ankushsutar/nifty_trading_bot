...
CAPITAL_TIERS: dict[str, CapitalTier] = {
    ...
    "MICRO": CapitalTier(
        ...
        allowed_strategies=["MOMENTUM", "GAMMA_BLAST", "PASSIVE_ASYMMETRIC_SCALPER"],
    ...
    "SMALL": CapitalTier(
        ...
        allowed_strategies=["MOMENTUM", "GAMMA_BLAST", "STRADDLE_SCALP", "ZERO_TO_HERO", "PASSIVE_ASYMMETRIC_SCALPER"],
