...
def run_bot():
    ...
    parser.add_argument("--strategy", type=str, default="STRADDLE", choices=["STRADDLE", "ORB", "MOMENTUM", "VWAP", "OHL", "INSIDE_BAR", "GAMMA_BLAST", "STRADDLE_SCALP"], help="Choose Strategy")
    ...
    elif args.strategy in ["MOMENTUM", "GAMMA_BLAST", "STRADDLE_SCALP"]:
